...
|19 |@Transactional | 1. @Transactional<br>2. @Transactional(rollbackFor = Exception.class)<br>3. @Transactional(readOnly = true)<br>4. @Transactional(propagation = Propagation.REQUIRES_NEW, isolation = Isolation.SERIALIZABLE) |
